...
Nesta aula, aprendi a testar, unitariamente, uma API REST para o gerenciamento de estoques de cerveja. Desenvolvi testes unitários para validar o sistema de gerenciamento de estoques de cerveja, e estudei os principais conceitos e vantagens de criar testes unitários com JUnit e Mockito.
...
Abaixo, seguem links , sobre tópicos mencionados durante a aula(DEIXADO PELO PROFESSOR):
